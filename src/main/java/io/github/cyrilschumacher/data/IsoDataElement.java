...
public enum IsoDataElement implements DataElement {
    ...
    PRIMARY_ACCOUNT_NUMBER(2, "Primary Account Number", 19, IsoDataTypeLength.VARIABLE, DataType.NUMERIC),
    ...
    ACQUIRING_INSTITUTION_IDENTIFICATION_CODE(32, "Acquiring institution identification code", 11, IsoDataTypeLength.VARIABLE, DataType.NUMERIC),
    FORWARDING_INSTITUTION_IDENTIFICATION_CODE(33, "Forwarding institution identification code", 11, IsoDataTypeLength.VARIABLE, DataType.NUMERIC),
    PRIMARY_ACCOUNT_NUMBER_EXTENDED(34, "Primary account number, extended", 11, IsoDataTypeLength.VARIABLE, DataType.NUMERIC, DataType.SPECIAL),
    TRACK_2_DATA(35, "Track 2 data", 37, IsoDataTypeLength.VARIABLE, DataType.NUMERIC, DataType.ALPHA, DataType.SPECIAL),
    TRACK_3_DATA(36, "Track 3 data", 107, IsoDataTypeLength.VARIABLE, DataType.NUMERIC),
    ...
    ADDITIONAL_RESPONSE_CODE(44, "Additional response data", 25, IsoDataTypeLength.VARIABLE, DataType.ALPHA, DataType.NUMERIC),
    TRACK_1_DATA(45, "Track 1 data", 76, IsoDataTypeLength.VARIABLE, DataType.ALPHA, DataType.NUMERIC),
    ADDITIONAL_DATA(46, "Additional data", 999, IsoDataTypeLength.VARIABLE, DataType.ALPHA, DataType.NUMERIC),
    ADDITIONAL_DATA_NATIONAL(47, "Additional data (national)", 999, IsoDataTypeLength.VARIABLE, DataType.ALPHA, DataType.NUMERIC),
    ADDITIONAL_DATA_PRIVATE(48, "Additional data (private)", 999, IsoDataTypeLength.VARIABLE, DataType.ALPHA, DataType.NUMERIC),
    ...
    ADDITIONAL_AMOUNTS(54, "Additional amounts", 120, IsoDataTypeLength.VARIABLE, DataType.ALPHA, DataType.NUMERIC),
    ICC_DATA(55, "ICC data", 999, IsoDataTypeLength.VARIABLE, DataType.ALPHA, DataType.NUMERIC, DataType.SPECIAL),
    ...
    private final DataTypeLength dataTypeLength;
    private final DataType[] dataTypes;

    IsoDataElement(final int dataField, final String description, final int length, final DataType... types) {
        this(dataField, description, length, IsoDataTypeLength.FIXED, types);
    }

    IsoDataElement(final int dataField, final String description, final int length, final DataTypeLength dataTypeLength, final DataType... dataTypes) {
    ...
    @Override
    public DataTypeLength getTypeLength() {
