...
import io.github.cyrilschumacher.data.IsoDataTypeLength;
...
enum DummyDataElement implements DataElement {
    ...
    ACQUIRER_INSTITUTION_ID_CODE(32, "Acquirer Institution Id Code", 99, IsoDataTypeLength.VARIABLE, DataType.NUMERIC),
    ...
    CARD_ACCEPTOR_NAME_LOCATION(43, "Card Acceptor Name/Location", 99, IsoDataTypeLength.VARIABLE, DataType.ALPHA, DataType.NUMERIC),
    ...
    DummyDataElement(final int dataField, final String description, final int length, final DataTypeLength dataTypeLength, final DataType... dataTypes) {
