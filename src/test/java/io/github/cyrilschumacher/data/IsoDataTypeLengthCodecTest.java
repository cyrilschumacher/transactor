...
/**
 * Unit tests for the class: {@link IsoDataTypeLengthCodec}.
 */
@DisplayName("Unit tests for `DefaultDataTypeLength` class.")
class IsoDataTypeLengthCodecTest {
    ...
    class ForFixedLengthElement {
        ...
        class WhenElementIsDecoded {
            ...
            void shouldEncodeValue() {
                ...
                Mockito.when(dataElementMock.getMaximumLength()).thenReturn(16);
                Mockito.when(dataElementMock.getTypes()).thenReturn(types);

                // When
                var encodedValue = IsoDataTypeLengthCodec.FIXED.encode(value, dataElementMock, StandardCharsets.US_ASCII);
            ...
            void shouldDecodeValue() {
                ...
                // When
                var decodedValue = IsoDataTypeLengthCodec.FIXED.decode(buffer, dataElementMock, StandardCharsets.US_ASCII);
            ...
            void shouldDecodeValueWithInaccurateLength() {
                ...
                Mockito.when(dataElementMock.getMaximumLength()).thenReturn(10);
            ...
            void shouldThrowExceptionForLengthTooLong() {
                ...
                Mockito.when(dataElementMock.getMaximumLength()).thenReturn(32);

                // When
                var exception = Assertions.assertThrows(BufferUnderflowException.class, () -> IsoDataTypeLengthCodec.FIXED.decode(buffer, dataElementMock, StandardCharsets.US_ASCII));
    ...
    class ForVariableLengthElement {
        ...
        class WhenElementIsDecoded {
            ...
            void shouldDecodeValueWithLengthOnTwoDigitsAsLength() {
                ...
                var variableDataTypeLength = IsoDataTypeLengthCodec.VARIABLE;
                var value = "164035502197074574".getBytes(StandardCharsets.US_ASCII);
                var buffer = ByteBuffer.wrap(value);

                Mockito.when(dataElementMock.getMaximumLength()).thenReturn(99);
            ...
            void shouldDecodeValueWithLengthOnThreeDigits() {
                ...
                Mockito.when(dataElementMock.getMaximumLength()).thenReturn(999);
        ...
        class WhenElementIsEncoded {
            ...
            void shouldThrowExceptionForExceededLength() {
                ...
                Mockito.when(dataElementMock.getMaximumLength()).thenReturn(9);

                // When
                var exception = Assertions.assertThrows(IsoDataTypeLengthCodec.IllegalElementLengthException.class, () -> variableDataTypeLength.encode(value, dataElementMock, StandardCharsets.US_ASCII));

                // Then
                var expectedException = new IsoDataTypeLengthCodec.IllegalElementLengthException(16, 9);
